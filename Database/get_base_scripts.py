...
if __name__ == "__main__":
    visdial = VisDialAnnotation("F:\\RAGInteractIR\datasets\\VisDial\\visdial_1.0_train.json")
    
    image_root = "F:\\RAGInteractIR\\datasets\\MSCOCO"
    with open("F:\\RAGInteractIR\\datasets\VisDial\\coco2014_id_to_relpath.json", "r") as f:
